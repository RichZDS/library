...
#
get_filename_component(filename "F:/Code/Library/build/_deps/oatpp_web-subbuild/oatpp_web-populate-prefix/src/1.3.0.zip" ABSOLUTE)
get_filename_component(directory "F:/Code/Library/build/_deps/oatpp_web-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-oatpp_web-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-oatpp_web-populate${i}")
