...
#
get_filename_component(filename "F:/Code/Library/build/_deps/oatpp-subbuild/oatpp-populate-prefix/src/1.3.0.zip" ABSOLUTE)
get_filename_component(directory "F:/Code/Library/build/_deps/oatpp-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-oatpp-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-oatpp-populate${i}")
